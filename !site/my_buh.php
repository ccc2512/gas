<?php
 ...
 function show_ost(ost_isx_1, ost_isx_2, ost_isx_3, ost_isx_4, ost_isx_5, ost_isx_6) {
  //alert('ost_isx_1 = '+ost_isx_1);
  //alert('ost_isx_2 = '+ost_isx_2);
  //alert('ost_isx_3 = '+ost_isx_3);
 ...
 ?>
 <?php
  echo '<script>show_ost(\''.$ost_isx_1.'\', \''.$ost_isx_2.'\', \''.$ost_isx_3.'\', \''.$ost_isx_4.'\', \''.$ost_isx_5.'\', \''.$ost_isx_6.'\');</script>';
 ?>
 <?php
  echo '
  <script>
