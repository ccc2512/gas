...
if ($act=='add') { // ------------------------------- ADD -------------------------------
  ...
  // Вставка в середину Вставка в середину Вставка в середину Вставка в середину Вставка в середину Вставка в середину Вставка в середину Вставка в середину
  $temp_rubl2litr = ($gas_summ / $gas_litr);
  mysql_query('INSERT INTO gas
  (
  status,
