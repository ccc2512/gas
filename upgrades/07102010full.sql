...
--
-- Хост: localhost
-- Время создания: Окт 07 2010 г., 18:12
...
(0, 1, 1, 0, ' Все категории', 1),
(1, 1, 1, 7, ' Еда и продукты', 1),
...
(100, 1, 1, 4, 'С карты в кошелёк', 1),
(101, 1, 1, 5, 'В кошелёк с карты', 2),
(102, 1, 1, 2, 'Поездки', 1),
(103, 1, 1, 1, 'Непонятно куда', 1),
(104, 1, 1, 1, 'Комиссия банкомата', 1),
(106, 2, 1, 1, 'ЗП', 2),
(107, 2, 1, 1, 'Авто', 1);
...
(69, 1, 2, 1286398800, 2, 10000.00, 106, -1, 1),
(70, 1, 2, 1286398800, 1, 500.00, 107, 86, 1);
...
(1, 1, 9382617, 'ccc', 'ccc', 1286464163, '', 17909, '1', 'Сергей', '', 'Страхов', NULL, NULL, NULL, NULL, 0, NULL),
(2, 1, 0, 'smallll', 'smallll', 1286458279, '', 204, '2', 'Константин', ' ', 'Страхов', NULL, NULL, NULL, NULL, 0, NULL),
